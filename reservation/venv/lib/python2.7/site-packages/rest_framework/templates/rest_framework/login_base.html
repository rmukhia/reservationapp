...
{% block body %}
<body class="container" style = "background-image:url('/static/assets/images/ixia.jpg')!important; background-size:contain;">
  <div class="container-fluid" style="margin-top: 30px">
    <div class="row-fluid">
      <div class="well" style="width: 320px; margin-left: auto; margin-right: auto">
        <div class="row-fluid">
          <div>
            {% block branding %}<h3 style="margin: 0 0 20px;">Reservation App</h3>{% endblock %}
          </div>
        </div><!-- /row fluid -->
